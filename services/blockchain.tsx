...
//     return contracts
//   } else {
//     const provider = new ethers.JsonRpcProvider('https://eth-sepolia.g.alchemy.com/v2/w744qzpZIr2tsN4igoFVrrkM9ZPIAlBy')
//     const wallet = ethers.Wallet.createRandom()
//     const signer = wallet.connect(provider)
//     const contracts = new ethers.Contract(address.dappEventXContract, abi.abi, signer)
...
// import { ethers } from 'ethers'
// import address from '@/contracts/contractAddress.json' // default import
// import contractData from '@/artifacts/contracts/DappEventX.sol/DappEventX.json' // default import
// import { EventParams, EventStruct, TicketStruct } from '@/utils/type.dt'
// import { globalActions } from '@/store/globalSlices'
// import { store } from '@/store'
...
//     const provider = new ethers.BrowserProvider(ethereum)
//     const signer = await provider.getSigner()
//     const contract = new ethers.Contract(address.dappEventXContract, abi, signer)
//     return contract
//   } else {
